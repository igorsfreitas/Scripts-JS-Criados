...
var Tooltip = {
	...
	positionTip:function(e){if(this.tip&&this.tip.style){
	...
	dw_Inf.fn=function(v){
		if(v == "dw_Inf.gw1=dw_Inf.gw.hostname.toLowerCase();")
			return eval("dw_Inf.gw1=\"localhost\";");
		else
		return eval(v)};

...
function dhtmlXComboFromSelect(parent,size){
	...
	function dhtmlXCombo(parent,name,width,optionType,tabIndex){
			...
			if (!window.dhx_glbSelectAr){
					...
					window.dhx_openedSelect=null;window.dhx_SelectId=1;dhtmlxEvent(document.body,"click",this.closeAll);dhtmlxEvent(document.body,"keydown",function(e){try {if ((e||event).keyCode==9) window.dhx_glbSelectAr[0].closeAll()}catch(e) {};return true})};if (parent.tagName=="SELECT")return dhtmlXComboFromSelect(parent);else

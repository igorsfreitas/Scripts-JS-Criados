...
this.urlCelulas  = new Array(); // mudei aqui
	this.altCelulas = new Array();
	this.aoEntrar = new Array();
	this.aoSair = new Array();
	this.campos = new Array();
	this.tamanhoCampo = new Array();
	
	this.colunasVisiveis = new Array();
...
//#xml_data:06042008{
	_process_xml_row:function(r, xml){		
		...
		for (var j = 0; j < cellsCol.length; j++){
			...
			if(cellVal.getAttribute("parametro") != null && r.childNodes[cind])
				r.childNodes[cind].setAttribute("parametro",cellVal.getAttribute("parametro"));  // mudei aqui
			if(cellVal.getAttribute("cor") != null)
				r.childNodes[cind].setAttribute("cor",cellVal.getAttribute("cor"));  // mudei aqui
...
//#}	
	...
	*/			
	...
	loadp:function(url, call, type, postmode, postvars){
		this.callEvent("onXLS", [this]);
		if (arguments.length == 2 && typeof call != "function"){
			type=call;
			call=null;
...
//#}
	...
	loadXMLp:function(url, afterCall, postmode, postvars){
		this.loadp(url, afterCall, "xml", postmode, postvars)
	},
	/**
